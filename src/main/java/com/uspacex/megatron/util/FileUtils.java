package com.uspacex.megatron.util;
...
/**
 * 文件操作工具类
 * 包含：文件的创建、删除、复制、压缩、解压以及目录的创建、删除、复制、压缩解压等功能
 */
public class FileUtils extends org.apache.commons.io.FileUtils {
    ...
    public static String uuidFileName(String fileName) {
        return UuidUtil.getTimeBasedUuid() + "." + getFileType(fileName);
    }

    /**
     * 判断文件夹是否存在，如不存在则创建（不递归创建）
     */
    public static void isFolderExistAndCreate(String folderName) {
